...
// challengeProgress.ts/discordEmbeds.ts. No screenshot/multipart support,
// since completion announcements don't carry a Dink-attached image.
...
export async function relayToDiscord(webhookUrl: string | null, embed: DiscordEmbed): Promise<void> {
