...
// No single "generic pet" icon exists on the wiki -- this is the group
// photo from the Menagerie page, the closest thing to one.
const PETS_ICON_URL = 'https://oldschool.runescape.wiki/images/Pets_in_a_menagerie.png';
...
export const PRESET_ICONS: { url: string; label: string }[] = [
  ...
  { url: CLUE_ICON_URL, label: 'Clue scroll' },
